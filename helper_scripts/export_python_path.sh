...
export PYTHONPATH="$PROJECT_ROOT:$PROJECT_ROOT/src:$PROJECT_ROOT/src/utils:$PROJECT_ROOT/src/utils/cli:$PROJECT_ROOT/test:$PROJECT_ROOT/test/utils:$PROJECT_ROOT/test/utils/cli"
