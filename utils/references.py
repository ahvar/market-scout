...
original_dispatcher_file = (
    project_root / "patch" / "ibpy2_original_dispatcher.py"
)
modified_dispatcher_file = (
    project_root / "patch" / "ibpy2_modified_dispatcher.py"
)
dispatcher_patch_file = project_root / "patch" / "ibpy2_dispatcher.patch"
...
ibpy2_original_init_file = project_root / "patch" / "ibpy2_original_init.py"
ibpy2_modified_init_file = project_root / "patch" / "ibpy2_modified_init.py"
ibpy2_init_patch_file = project_root / "patch" / "fix_syntax_error.patch"
ibpy2_init_filepath = (
    project_root
    / "envs"
    / "lib"
...
ibpy2_original_overloading_file = (
    project_root / "patch" / "ibpy2_original_overloading.py"
)
ibpy2_modified_overloading_file = (
    project_root / "patch" / "ibpy2_modified_overloading.py"
)
ibpy2_overloading_patch_file = (
    project_root / "patch" / "ibpy2_overloading.patch"
)
...
ibpy2_original_eclient_socket = (
    project_root / "patch" / "ibpy2_original_eclient_socket.py"
)
ibpy2_modified_eclient_socket = (
    project_root / "patch" / "ibpy2_modified_eclient_socket.py"
)
ibpy2_eclient_socket_patch = (
    project_root / "patch" / "ibpy2_eclient_socket.patch"
)
...
ibpy2_original_ereader = project_root / "patch" / "ibpy2_original_ereader.py"
ibpy2_modified_ereader = project_root / "patch" / "ibpy2_modified_ereader.py"
ibpy2_ereader_patch = project_root / "patch" / "ibpy2_ereader.patch"
...
ibpy2_original_message = project_root / "patch" / "ibpy2_original_message.py"
ibpy2_modified_message = project_root / "patch" / "ibpy2_modified_message.py"
ibpy2_message_patch = project_root / "patch" / "ibpy2_message.patch"
