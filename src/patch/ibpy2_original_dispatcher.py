...
class Dispatcher(object):
    ...
    def __call__(self, name, args):
        ...
        for listener in listeners:
            try:
                ...
                errmsg = "Exception in message dispatch.  " "Handler '%s' for '%s'"
    ...
    def registerAll(self, listener):
        ...
        return self.register(
            listener, *[maybeName(i) for v in self.messageTypes.values() for i in v]
        )
    ...
    def unregisterAll(self, listener):
        ...
        return self.unregister(
            listener,
            *[maybeName(i) for v in list(self.messageTypes.values()) for i in v]
        )
